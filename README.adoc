...
`pass:[->>]`, don't do it like this. You will have some exception.
...
ClojureScript browser console only. Appended `n` to these two macro names means *Nested
forms*. You can debug every nested form without affecting code evaluations. This feature
is very useful, especially when you analyze other developer's source code.
