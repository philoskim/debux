...
*Debux* is a simple but useful debugging library for Clojure and ClojureScript. I wrote
...
* v0.3.11
** Changed: Too long forms are truncated and printed with pass:q[`...`] symbol.
...
Now you can see the evaluated output of outermost form by using `dbg` or `clog` and the
